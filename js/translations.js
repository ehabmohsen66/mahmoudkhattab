...
const TRANSLATIONS = {
  ru: {
    ...
    navStory: 'История @russborn',
    navStay: 'Гостевой дом',
    ...
    // Influencer / Guest Story Section (@russborn)
    storyTag: 'ЭКСКЛЮЗИВНЫЙ ОТЗЫВ · @RUSSBORN',
    storyTitle: '«Жизнь учит меня доверять мужчинам»',
    storySubtitle: 'Искренние впечатления и живые кадры из экспедиции в Белую Пустыню с Махмудом Хаттабом',
    storyAuthorName: '@russborn',
    storyAuthorRole: 'Traveler & Content Creator',
    storyExpeditionBadge: 'Белая Пустыня, Сахара · Ноябрь 2024',
    storyQuoteP1: 'Жизнь учит меня доверять мужчинам. Мне кажется, что в своих поездках, я в основном прохожу уроки по тому, как это - принимать от мужчины и доверять им. Не просто доверять, а доверять на 100%, и не только свое благополучие, свою безопасность, но и безопасность моей группы. Это чистая проекция, как если бы я доверила своему мужчине себя и своего ребенка. Я будто специально еду в такие места, где сама культура подразумевает полную сдачу женщины в руки мужчины. Другие женщины и другие мужчины будто показывают мне «смотри, вот так можно, но возьми только суть, и адаптируй ее в рамках своего времени и своей культуры».',
    storyQuoteP2: 'Спасибо, Махмуд за бережное сопровождение! И за то, что через деловое партнерство показываешь, как это должно быть и в семейных отношениях. Я знаю, что мы тоже твой урок в этой теме веков - мужчина и женщина!',
    storyCtaTitle: 'Мечтаете о таком же незабываемом сафари в Белую Пустыню?',
    storyCtaDesc: 'Индивидуальный маршрут 4х4, проверенный бедуинский кемпинг, звездное небо Сахары и 100% безопасность.',
    storyCtaBtn: 'Обсудить тур в Белую Пустыню',
    storyPhotoCaption: 'Махмуд Хаттаб и @russborn в песках Белой Пустыни',
    storyPhotoLocation: 'Белая Пустыня, Египет',
    storyVideo1Title: 'Экспедиция по Белой Пустыне',
    storyVideo1Desc: 'Живые моменты и инопланетные пейзажи Сахары',
    storyVideo2Title: 'Атмосфера и настроение Сахары',
    storyVideo2Desc: 'Джип-сафари 4х4 и песчаные дюны',
    storyTabRu: 'Русский (Оригинал)',
    storyTabEn: 'English',
    storyTabZh: '中文',
    ...
    // Guest House (Makai Pyramids Guest House)
    guestHouseBadge: 'Эксклюзивное размещение в Гизе',
    guestHouseTitle: 'Makai Pyramids Guest House',
    guestHouseSubtitle: 'Ваш дом с прямым панорамным видом на Великие Пирамиды',
    guestHouseDesc: 'Просыпайтесь с видом на Пирамиды Гизы и засыпайте под звездами Сахары. Уютный бутик-дом прямо у подножия плато Гиза сочетает современный комфорт, восточное гостеприимство и персональную заботу Махмуда.',
    guestHouseFeature1Title: 'Панорамная терраса',
    guestHouseFeature1Desc: 'Завтрак с лучшим видом на Пирамиды и Сфинкса, а вечером — обзор лазерного шоу прямо с крыши.',
    guestHouseFeature2Title: 'Комфортабельные номера',
    guestHouseFeature2Desc: 'Современные кровати, кондиционер, скоростной Wi-Fi, стильный интерьер и тишина.',
    guestHouseFeature3Title: 'Традиционный завтрак',
    guestHouseFeature3Desc: 'Свежеприготовленный домашний египетский завтрак, свежие фрукты и бедуинский чай.',
    guestHouseFeature4Title: 'Трансфер и забота 24/7',
    guestHouseFeature4Desc: 'Встреча в аэропорту, трансферы и организация экскурсий без хлопот напрямую с Махмудом.',
    guestHouseBtnWhatsApp: 'Забронировать через WhatsApp',
    guestHouseBtnBooking: 'Открыть на Booking.com',
    guestHouseWaMsg: 'Здравствуйте, Махмуд! Я хочу забронировать проживание в Makai Pyramids Guest House.',
    
    // Comments & Reviews Form
    commentsHeading: 'Слова наших гостей & Отзывы',
    commentsSubheading: 'Поделитесь впечатлениями о вашей экскурсии с Махмудом или прочитайте отзывы путешественников',
    btnWriteComment: 'Написать отзыв',
    btnCloseComment: 'Скрыть форму',
    commentFormTitle: 'Оставить отзыв о гиде Махмуде',
    commentNameLabel: 'Ваше имя',
    commentLocationLabel: 'Город / Страна',
    commentRatingLabel: 'Ваша оценка',
    commentAvatarLabel: 'Ваше фото / аватар (необязательно)',
    commentAvatarHint: 'Если фото не выбрано, в качестве аватара будет установлена эмблема сайта',
    commentTextLabel: 'Ваш отзыв',
    commentTextPlaceholder: 'Расскажите о вашей поездке: впечатления от экскурсии, отношение гида, безопасность, комфорт...',
    commentCaptchaLabel: 'Антиспам-проверка',
    commentCaptchaPlaceholder: 'Ответ',
    btnSubmitComment: 'Опубликовать отзыв',
    commentSubmitting: 'Публикуем...',
    commentSuccessMsg: 'Спасибо! Ваш отзыв успешно опубликован на сайте.',
    commentNoReviewsYet: 'Пока нет отзывов. Будьте первыми, кто поделится впечатлениями о туре с Махмудом!',
  ...
  en: {
    ...
    // Influencer / Guest Story Section (@russborn)
    storyTag: 'INFLUENCER SPOTLIGHT · @RUSSBORN',
    storyTitle: '"Life is teaching me to trust men"',
    storySubtitle: 'Heartfelt reflection and live footage from the White Desert expedition with Mahmoud Khattab',
    storyAuthorName: '@russborn',
    storyAuthorRole: 'Traveler & Content Creator',
    storyExpeditionBadge: 'White Desert, Sahara · November 2024',
    storyQuoteP1: 'Life is teaching me to trust men. It feels like during my travels, I am mainly learning lessons on what it means to receive from men and trust them. Not just trust, but trust 100% — and not only my own well-being and safety, but also the safety of my group. It is a pure projection, just as if I entrusted myself and my child to my man. It is as if I deliberately travel to places where the culture itself implies a woman\'s complete surrender into the hands of a man. Other women and other men seem to be showing me: "Look, this is possible, but take only the essence, and adapt it within the context of your own time and culture."',
    storyQuoteP2: 'Thank you, Mahmoud, for the attentive and caring guidance! And for showing, through a business partnership, how it should be in family relationships too. I know that we are also your lesson in this timeless theme — man and woman!',
    storyCtaTitle: 'Dreaming of your own White Desert safari?',
    storyCtaDesc: 'Private 4x4 expedition, verified Bedouin camp, starlit Sahara nights, and 100% safety & care.',
    storyCtaBtn: 'Plan White Desert Tour',
    storyPhotoCaption: 'Mahmoud Khattab with @russborn in the White Desert',
    storyPhotoLocation: 'White Desert, Egypt',
    storyVideo1Title: 'White Desert Expedition',
    storyVideo1Desc: 'Authentic moments and otherworldly landscapes',
    storyVideo2Title: 'Sahara Atmosphere & Vibes',
    storyVideo2Desc: '4x4 desert convoy across sand dunes',
    storyTabRu: 'Русский (Original)',
    storyTabEn: 'English',
    storyTabZh: '中文',
    ...
    // Guest House (Makai Pyramids Guest House)
    guestHouseBadge: 'Exclusive Stay in Giza',
    guestHouseTitle: 'Makai Pyramids Guest House',
    guestHouseSubtitle: 'Your Private Haven with Direct Panoramic Pyramids Views',
    guestHouseDesc: 'Wake up to breathtaking views of the Great Pyramids and fall asleep under the starlit Egyptian sky. Located steps from the Giza Plateau, Makai Guest House blends boutique comfort, authentic hospitality, and personalized care by Mahmoud.',
    guestHouseFeature1Title: 'Panoramic Rooftop Terrace',
    guestHouseFeature1Desc: 'Enjoy breakfast facing the Great Pyramids & Sphinx, and watch the evening Sound & Light show.',
    guestHouseFeature2Title: 'Deluxe Modern Rooms',
    guestHouseFeature2Desc: 'Premium bedding, powerful A/C, high-speed Wi-Fi, modern private bathrooms & serene atmosphere.',
    guestHouseFeature3Title: 'Authentic Fresh Breakfast',
    guestHouseFeature3Desc: 'Freshly prepared traditional Egyptian breakfast, fresh seasonal fruits, and aromatic tea & coffee.',
    guestHouseFeature4Title: 'Seamless Airport & Tour VIP Care',
    guestHouseFeature4Desc: 'Hassle-free airport pick-up, private transport, and personalized tours organized directly with Mahmoud.',
    guestHouseWaMsg: 'Hello Mahmoud! I would like to book a stay at Makai Pyramids Guest House.',
    
    // Comments & Reviews Form
    commentsHeading: 'Words from our guests',
    commentsSubheading: 'Share your personal experience with Mahmoud or read feedback from fellow travelers',
    btnWriteComment: 'Write a Review',
    btnCloseComment: 'Hide Form',
    commentFormTitle: 'Leave a Review for Guide Mahmoud',
    commentNameLabel: 'Your Name',
    commentLocationLabel: 'City / Country',
    commentRatingLabel: 'Your Rating',
    commentAvatarLabel: 'Avatar Photo (optional)',
    commentAvatarHint: 'If no photo is selected, the official website emblem will be used as your avatar',
    commentTextLabel: 'Your Review',
    commentTextPlaceholder: 'Share your thoughts: tour experience, Mahmoud\'s guiding, comfort, safety, history...',
    commentCaptchaLabel: 'Anti-Spam Verification',
    commentCaptchaPlaceholder: 'Answer',
    btnSubmitComment: 'Publish Review',
    commentSubmitting: 'Publishing...',
    commentSuccessMsg: 'Thank you! Your review has been published on the website.',
    commentNoReviewsYet: 'No guest comments yet. Be the first to share your experience with Mahmoud!',
  ...
  zh: {
    ...
    // Influencer / Guest Story Section (@russborn)
    storyTag: '达人真实体验 · @RUSSBORN',
    storyTitle: '“生活在教会我去信任男人”',
    storySubtitle: '与马哈茂德·哈塔卜同行的撒哈拉白沙漠探险真实记录与感悟',
    storyAuthorName: '@russborn',
    storyAuthorRole: '旅行达人 & 知名博主',
    storyExpeditionBadge: '撒哈拉白沙漠 · 2024年11月',
    storyQuoteP1: '生活在教会我去信任男人。我觉得在自己的每一次旅行中，我主要都在上一堂关于如何接受男性的给予并给予信任的课。不仅是信任，而是100%的交付与信任——这不仅关乎我自己的福祉与安全，也关乎我整个团队的安全。这是一种纯粹的投射，就如同我把我自己和我的孩子托付给了我的伴侣。我仿佛是有意来到这些地方，这里的文化本身就意味着女性将自己全然交托在男人手中。这里的男男女女仿佛在向我展示：“看，这样也是可以的，但请只取其精髓，并在你所处的时代与文化中去融会贯通。”',
    storyQuoteP2: '谢谢你，马哈茂德，感谢你无微不至的守护与陪伴！也感谢你通过商业合作，向我们展示了在家庭关系中本该有的模样。我知道，在这千百年来永恒的“男人与女人”的主题中，我们同样也是你的功课！',
    storyCtaTitle: '也想体验同款终生难忘的白沙漠探险之旅吗？',
    storyCtaDesc: '专属丰田4x4越野探险、地道贝都因星空营地、极致风光与100%周全安全保障。',
    storyCtaBtn: '咨询白沙漠定制行程',
    storyPhotoCaption: '马哈茂德与 @russborn 漫步于白沙漠金色沙丘',
    storyPhotoLocation: '埃及·白沙漠',
    storyVideo1Title: '白沙漠探险实录',
    storyVideo1Desc: '真实旅行瞬间与震撼外星风貌',
    storyVideo2Title: '撒哈拉心境与越野体验',
    storyVideo2Desc: '4x4车队穿行于沙丘之巅',
    storyTabRu: 'Русский (原文)',
    storyTabEn: 'English',
    storyTabZh: '中文',
    ...
    // Guest House (Makai Pyramids Guest House)
    guestHouseBadge: '吉萨独家金字塔观景民宿',
    guestHouseTitle: 'Makai Pyramids Guest House',
    guestHouseSubtitle: '推窗即见吉萨金字塔的私享度假胜地',
    guestHouseDesc: '清晨在宏伟的金字塔晨光中醒来，夜晚在屋顶露台仰望璀璨星空。民宿紧邻吉萨高原景区，融合现代轻奢舒适设施与浓郁埃及待客之道，由马哈茂德团队提供贴心管家式服务。',
    guestHouseFeature1Title: '超大全景屋顶露台',
    guestHouseFeature1Desc: '直面三大金字塔与狮身人面像享用丰盛早餐，夜间尽览声光秀全景。',
    guestHouseFeature2Title: '现代轻奢舒适客房',
    guestHouseFeature2Desc: '舒适寝具、强劲冷暖空调、高速无线网络与独立卫浴，静谧安宁。',
    guestHouseFeature3Title: '地道现做特色早餐',
    guestHouseFeature3Desc: '新鲜制作的正宗埃及风味早餐、新鲜果盘与特色红茶咖啡。',
    guestHouseFeature4Title: '接送机与定制游一站式无忧',
    guestHouseFeature4Desc: '提供开罗机场VIP接送机与私人专属行程无缝衔接，省心省力。',
    guestHouseWaMsg: '您好马哈茂德！我想预订马凯金字塔民宿（Makai Pyramids Guest House）住宿。',
    
    // Comments & Reviews Form
    commentsHeading: '客人真实评价与留言',
    commentsSubheading: '分享您与马哈茂德同行的旅行体验，或阅读其他客人的真实评价',
    btnWriteComment: '发表评价',
    btnCloseComment: '收起表单',
    commentFormTitle: '为向导马哈茂德留下真实评价',
    commentNameLabel: '您的姓名',
    commentLocationLabel: '城市 / 国家',
    commentRatingLabel: '您的评分',
    commentAvatarLabel: '个人头像照片（选填）',
    commentAvatarHint: '若未上传头像，将自动使用网站官方徽标作为您的专属头像',
    commentTextLabel: '评价内容',
    commentTextPlaceholder: '分享您的旅行体验：游览体验、向导专业度、服务态度、安全性与舒适度...',
    commentCaptchaLabel: '防垃圾安全验证',
    commentCaptchaPlaceholder: '计算结果',
    btnSubmitComment: '公开发布评价',
    commentSubmitting: '正在发布...',
    commentSuccessMsg: '感谢您的评价！评价已成功发布于网站。',
    commentNoReviewsYet: '暂无留言，快来成为第一个分享旅行体验的客人吧！',
