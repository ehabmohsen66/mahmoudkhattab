...
const TRANSLATIONS = {
  ru: {
    ...
    commentsHeading: 'Отзывы и впечатления гостей',
    commentsSubheading: 'Поделитесь вашими впечатлениями или прочитайте отзывы других путешественников',
    btnWriteComment: 'Написать отзыв',
    btnCloseComment: 'Скрыть форму',
    commentFormTitle: 'Оставить отзыв о проживании',
    ...
    commentTextPlaceholder: 'Расскажите о впечатлениях: атмосфера, вид на пирамиды, комфорт, завтраки...',
    ...
    commentNoReviewsYet: 'Пока нет отзывов. Будьте первыми, кто поделится впечатлениями!',
  ...
  en: {
    ...
    // Comments & Reviews Form
    commentsHeading: 'Guest Reviews & Comments',
    commentsSubheading: 'Share your personal experience or browse authentic thoughts from fellow travelers',
    btnWriteComment: 'Write a Review',
    btnCloseComment: 'Hide Form',
    commentFormTitle: 'Leave a Review for Your Stay',
    ...
    commentTextPlaceholder: 'Share your thoughts: atmosphere, direct pyramid views, comfort, breakfast...',
    ...
    commentNoReviewsYet: 'No guest comments yet. Be the first to share your experience!',
  ...
  zh: {
    ...
    commentsSubheading: '分享您在此入住的真实体会，或浏览其他旅友的入住体验',
    btnWriteComment: '发表评价',
    btnCloseComment: '收起表单',
    commentFormTitle: '留下您的入住评价',
    ...
    commentTextPlaceholder: '分享您的入住体验：金字塔近景、环境氛围、舒适度、早餐服务...',
    ...
    commentNoReviewsYet: '暂无留言，快来成为第一个分享入住体验的客人吧！',
