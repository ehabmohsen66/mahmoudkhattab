...
const TRANSLATIONS = {
  ru: {
    ...
    guestHouseBookingNote: 'Рейтинг 9.4+ на Booking.com • Гарантия лучшей цены при бронировании напрямую',
  ...
  en: {
    ...
    guestHouseBtnWhatsApp: 'Book Directly via WhatsApp',
    guestHouseBtnBooking: 'View on Booking.com',
    guestHouseBookingNote: 'Rated 9.4+ on Booking.com • Best rate guarantee when booking directly with Mahmoud',
  ...
  zh: {
    ...
    guestHouseBtnWhatsApp: '通过微信/WhatsApp直订',
    guestHouseBtnBooking: '在 Booking.com 查看',
    guestHouseBookingNote: 'Booking.com 高分好评 9.4+ • 直订享专属优惠与接送机礼遇',
